...
<div class="glass-effect rounded-2xl shadow-xl p-8 mb-8">
    <div class="text-center">
        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-600 to-blue-600 rounded-xl mb-4 shadow-lg">
...
<nav aria-label="breadcrumb" class="mb-6">
    <ol class="flex items-center space-x-2 text-sm">
        <li>
            <a href="<?= route('employees.index') ?>" class="text-blue-600 hover:text-blue-800 transition-colors duration-200 flex items-center">
...
<div class="glass-effect rounded-2xl shadow-xl p-8">
    <form action="<?= route('employees.store') ?>" method="post" class="space-y-8" novalidate>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 appearance-none <?= isset($errors['role_id']) ? 'border-red-300 focus:ring-red-500' : '' ?>"
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 <?= isset($errors['notes']) ? 'border-red-300 focus:ring-red-500' : '' ?>"
                              id="notes" name="notes" rows="4" placeholder="Informações adicionais sobre o funcionário..."><?= htmlspecialchars($employee->notes ?? '') ?></textarea>
                </div>
        ...
        <div class="flex justify-between items-center pt-8 border-t border-gray-200">
            <a href="<?= route('employees.index') ?>" class="px-6 py-3 text-gray-600 bg-white/60 hover:bg-white/80 border border-gray-200 rounded-xl transition-all duration-200 font-medium flex items-center">
                <i class="fas fa-arrow-left mr-2"></i>
                Cancelar
            </a>
            <button type="submit" class="px-8 py-3 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white rounded-xl flex items-center font-semibold transition duration-300 transform hover:scale-105 shadow-lg">
