            ...
            <form action="<?= route('employees.update') ?>" method="post" class="space-y-6" novalidate>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text"
                               class="<?= CssClasses::inputClass(isset($errors['name'])) ?>"
                    ...
                    <div>
                        ...
                        <input type="email"
                               class="<?= CssClasses::inputClass(isset($errors['email'])) ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="password"
                               ...
                               id="password" name="password" <?= !$credential ? 'required' : '' ?>>
                    ...
                    <div>
                        ...
                        <input type="password"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                               id="password_confirmation" name="password_confirmation" <?= !$credential ? 'required' : '' ?>>
                    </div>
                </div>
