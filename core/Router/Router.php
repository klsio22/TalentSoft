...
class Router
{
   ...
   * This class follows the Singleton pattern and should be accessed via getInstance().
   */
   ...
   * This is part of the Singleton pattern implementation to ensure
   * that only one instance of the Router exists throughout the application.
   */
        ...
        if (!$routesRegistered) {
          // If routes aren't registered yet, display a simple error page
            ...
            echo '<html><body>' .
                 ...
                 '<p>Ocorreu um erro durante a inicialização do sistema.</p>' .
                 '</body></html>';
            exit;
        }
